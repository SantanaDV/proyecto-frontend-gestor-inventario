              ...
              <div className="grid grid-cols-1 gap-6">
                {tasks.map(tarea => (
                  <div key={tarea.id} className={`border border-gray-300 rounded-lg shadow-lg p-5 ${bgColor}`}>
                    <div className="flex">
                      <h3 className="text-lg font-semibold text-blue-600">{tarea.descripcion}</h3>
                      <div className="ml-auto flex gap-2">
                        <button><img className="w-6 h-6" src="editar.png" /></button>
                        <button><img className="w-6 h-6" src="eliminar.png" /></button>
                      </div>
                    </div>
